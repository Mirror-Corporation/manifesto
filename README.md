...
<picture>
  ...
  <img src="./assets/banner-forest.svg" alt="MIRROR — это не клон. это оживление." width="100%"/>
</picture>
...
<div align="center">
<h3><em>«Голос — последнее, что тело отпускает.<br/>Мы ловим его прежде, чем он упадёт.»</em></h3>
<sub>voice is the last thing the body lets go of. we catch it before it falls.</sub>
</div>
...
<sub><b>The Mirror Manifesto</b> · version 2 · 2026 · <a href="https://github.com/Mirror-Corporation">Mirror Corporation</a></sub>
<br/>
<sub>Discuss · challenge · suggest: <a href="https://github.com/Mirror-Corporation/manifesto/discussions">discussions</a></sub>
